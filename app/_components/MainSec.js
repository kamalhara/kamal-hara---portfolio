  ...
  return (
    <div className="md:mt-36 mt-10 h-auto">
      ...
      <p className="font-mono text-(--primary) mx-4 text-base sm:text-lg md:text-xl my-10 md:ml-[100px] md:mr-[200px]">
        Detail-oriented full-stack software engineer with great passion for
        building end-to-end web applications, creating beautiful UIs, developing
        robust backend systems, and delivering dynamic user experiences. Major
        tech stack includes Html, Css, JavaScript, Tailwind Css, ReactJS,
        NextJS, NodeJS, Express, MongoDB, and REST APIs. Devoted to developing
        customized full-stack solutions to meet organisational needs, highlight
